...
def build_nnunet_raw_dataset(
    ...
    for stem, image_path, mask_path in [*train_rows, *val_rows]:
        ...
        for dst, src in ((dst_img, image_path), (dst_mask, mask_path)):
...
def main() -> None:
    ...
    dataset_id = int(cropped_cfg["nnunet_dataset_id"])
    dataset_name = cropped_cfg["nnunet_dataset_name"]
    ...
    print(f"[INFO] Built cropped nnUNet dataset: {dataset_dir}")
